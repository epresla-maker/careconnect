      ...
      <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-[#F9FAFB] text-[#111827]'} ${pharmaRole ? 'pb-[146px]' : 'pb-40'}`}>
        <div className="max-w-[420px] mx-auto px-4 py-6">
          ...
          <div className="mb-8">
            ...
            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-[#6B7280]'}`}>(Gyógyszertári helyettesítési platform)</p>
          </div>
          ...
          {pharmaRole && (
            <div className="space-y-4">
              {activeTab === 'info' && <InfoTab pharmaRole={pharmaRole} darkMode={darkMode} />}
              {activeTab === 'calendar' && (
...
// Info Tab Component
function InfoTab({ pharmaRole, darkMode }) {
  return (
    <div className="prose max-w-none ">
      <h2 className={`text-3xl font-bold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-6`}>A Pharmagisterről bővebben</h2>
      
      <div className={`${darkMode ? 'bg-purple-900/30 border-purple-600' : 'bg-purple-50 border-[#6B46C1]'} border-l-4 p-6 mb-6 rounded-r-xl`}>
        <h3 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>Üdvözlünk a Pharmagister oldalán!</h3>
        <p className={`${darkMode ? 'text-gray-300' : 'text-[#374151]'} mb-3`}>
        ...
        <p className={`${darkMode ? 'text-gray-300' : 'text-[#374151]'}`}>
          Célunk, hogy megkönnyítsük a megfelelő munkaerő vagy munkaalkalom megtalálását a gyógyszerészeti szektorban.
        </p>
      </div>

      <h3 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-4`}>Hogyan Működik?</h3>
      <p className={`${darkMode ? 'text-gray-300' : 'text-[#374151]'} mb-6`}>
      ...
      {(pharmaRole === 'pharmacist' || pharmaRole === 'assistant') && (
        <div className="mb-8">
          <h3 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-4`}>Helyettesítőknek (Gyógyszerész, Szakasszisztens) 🧑‍⚕️</h3>
          
          <div className="space-y-6">
            <div>
              <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>1. Regisztráció és Profil Kitöltése</h4>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
            ...
            <div>
              <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>2. Igények Keresése</h4>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
            ...
            <div>
              <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>3. Jelentkezés Igényekre</h4>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
            ...
            <div>
              <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>4. Jelentkezéseid Kezelése (Vezérlőpult)</h4>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
      ...
      {pharmaRole === 'pharmacy' && (
        <div className="mb-8">
          <h3 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-4`}>Gyógyszertáraknak 🏢</h3>
          
          <div className="space-y-6">
            <div>
              <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>1. Regisztráció és Profil</h4>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
            ...
            <div>
              <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>2. Igények Feladása</h4>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
            ...
            <div>
              <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>3. Jelentkezők Kezelése (Vezérlőpult)</h4>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
            ...
            <div>
              <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-3`}>4. Igények Törlése</h4>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
      ...
      <div className="mb-8">
        <h3 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-4`}>Közös Funkciók 💬👤</h3>
        <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
      ...
      <div className={`${darkMode ? 'bg-yellow-900/30 border-yellow-600' : 'bg-yellow-50 border-yellow-500'} border-l-4 p-6`}>
        <h3 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-[#111827]'} mb-4`}>Tippek a Hatékony Használathoz ✨</h3>
        <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-[#374151]'} ml-4`}>
      ...
      <div className="mt-8 text-center">
        <p className={`${darkMode ? 'text-gray-400' : 'text-[#6B7280]'} italic`}>
